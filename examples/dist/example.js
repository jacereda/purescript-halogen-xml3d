...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];        
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(Example.example)(Data_Unit.unit)));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
