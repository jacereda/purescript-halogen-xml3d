...
(function(exports) {
  ...
  var renderMatModel = function (v) {
      ...
      throw new Error("Failed pattern match at DOM.XML3D.Indexed.Material line 17, column 18 - line 21, column 12: " + [ v.constructor.name ]);
  };
  exports["Matte"] = Matte;
...
(function(exports) {
  ...
  var renderWrapMode = function (v) {
      ...
      throw new Error("Failed pattern match at DOM.XML3D.Indexed.Texture line 12, column 18 - line 17, column 1: " + [ v.constructor.name ]);
  };
  ...
  var renderMinFilter = function (v) {
      ...
      throw new Error("Failed pattern match at DOM.XML3D.Indexed.Texture line 34, column 19 - line 42, column 1: " + [ v.constructor.name ]);
  };
  var renderMagFilter = function (v) {
      ...
      throw new Error("Failed pattern match at DOM.XML3D.Indexed.Texture line 47, column 19 - line 51, column 1: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var renderViewModel = function (v) {
      ...
      throw new Error("Failed pattern match at DOM.XML3D.Indexed.View line 15, column 19 - line 17, column 17: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var float3 = function (p) {
      return function (vs) {
          return Halogen_HTML_Elements.element("float3")(p)(Data_Functor.map(Data_Functor.functorArray)(function ($0) {
              return Halogen_HTML_Core.text(DOM_XML3D_Indexed_Vec3.renderVec3($0));
          })(vs));
      };
  };
  var $$float = function (p) {
      return function (vs) {
          return Halogen_HTML_Elements.element("float")(p)(Data_Functor.map(Data_Functor.functorArray)(function ($2) {
              return Halogen_HTML_Core.text(Data_Show.show(Data_Show.showNumber)($2));
          })(vs));
      };
  };
...
(function(exports) {
  ...
  var width = function ($1) {
      return Halogen_HTML_Properties.attr("width")(Data_Show.show(Data_Show.showInt)($1));
  };
  ...
  var id = Halogen_HTML_Properties.attr("id");
...
(function(exports) {
  ...
  var example = (function () {
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Example line 138, column 10 - line 143, column 12: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var head = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      ...
      render: Data_Function["const"](Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.script([ Halogen_HTML_Properties.src("http://www.xml3d.org/xml3d/script/xml3d.js") ])([  ]) ])), 
      "eval": function ($0) {
