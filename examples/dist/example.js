      ...
      var $$eval = (function () {
          ...
          return function (v) {
              ...
              if (v instanceof Touch) {
                  ...
                  throw new Error("Failed pattern match at Example line 165, column 7 - line 169, column 20: " + [ v1.constructor.name ]);
              };
              if (v instanceof Drawn) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              };
              throw new Error("Failed pattern match at Example line 160, column 10 - line 171, column 16: " + [ v.constructor.name ]);
          };
      })();
