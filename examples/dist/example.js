      ...
      return function (a) {
          var fromDone = function (v) {
              ...
              return __unused()((function () {
                  ...
                  throw new Error("Failed pattern match at Control.Monad.Rec.Class line 132, column 28 - line 132, column 42: " + [ v.constructor.name ]);
              })());
          };
          ...
          return function __do() {
              ...
              (function () {
                  while (!(function __do() {
                      ...
                      throw new Error("Failed pattern match at Control.Monad.Rec.Class line 121, column 5 - line 126, column 26: " + [ v1.constructor.name ]);
                  })()) {
...
})(PS["DOM.XML3D.Event.Types"] = PS["DOM.XML3D.Event.Types"] || {});
(function(exports) {
    "use strict";
  var $foreign = PS["DOM.XML3D.Event.Types"];
  var DOM_Event_Types = PS["DOM.Event.Types"];
  var Data_Foreign = PS["Data.Foreign"];
  var Unsafe_Coerce = PS["Unsafe.Coerce"];        
  var timeStart = $foreign.field([ "timeStart" ]);
...
(function(exports) {
  ...
  var Data_Show = PS["Data.Show"];
  var Prelude = PS["Prelude"];        
  var AxisAngle = (function () {
      function AxisAngle(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      };
      AxisAngle.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new AxisAngle(value0, value1, value2, value3);
                  };
              };
          };
      };
  ...
  var renderAxisAngle = function (v) {
      return Data_Show.show(Data_Show.showNumber)(v.value0) + (" " + (Data_Show.show(Data_Show.showNumber)(v.value1) + (" " + (Data_Show.show(Data_Show.showNumber)(v.value2) + (" " + Data_Show.show(Data_Show.showNumber)(v.value3))))));
  };
  exports["AxisAngle"] = AxisAngle;
  exports["renderAxisAngle"] = renderAxisAngle;
})(PS["DOM.XML3D.Indexed.AxisAngle"] = PS["DOM.XML3D.Indexed.AxisAngle"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Point = (function () {
  ...
  var Directional = (function () {
      ...
      Directional.value = new Directional();
      return Directional;
  })();
  var Spot = (function () {
      function Spot() {
  ...
  var renderLightModel = function (v) {
      if (v instanceof Point) {
          return "urn:xml3d:light:point";
      };
      if (v instanceof Directional) {
          return "urn:xml3d:light:directional";
      };
      if (v instanceof Spot) {
          return "urn:xml3d:light:spot";
      };
      throw new Error("Failed pattern match at DOM.XML3D.Indexed.Light line 9, column 20 - line 12, column 11: " + [ v.constructor.name ]);
  };
  exports["Point"] = Point;
  exports["Directional"] = Directional;
  exports["Spot"] = Spot;
  exports["renderLightModel"] = renderLightModel;
})(PS["DOM.XML3D.Indexed.Light"] = PS["DOM.XML3D.Indexed.Light"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Matte = (function () {
  ...
  var renderMatModel = function (v) {
      if (v instanceof Matte) {
          return "urn:xml3d:material:matte";
      };
      if (v instanceof Diffuse) {
          return "urn:xml3d:material:diffuse";
      };
      if (v instanceof Phong) {
          return "urn:xml3d:material:phong";
      };
      if (v instanceof Point) {
          return "urn:xml3d:material:point";
      };
      throw new Error("Failed pattern match at DOM.XML3D.Indexed.Material line 10, column 18 - line 14, column 12: " + [ v.constructor.name ]);
  };
  exports["Matte"] = Matte;
  exports["Diffuse"] = Diffuse;
  exports["Phong"] = Phong;
  exports["Point"] = Point;
  exports["renderMatModel"] = renderMatModel;
})(PS["DOM.XML3D.Indexed.Material"] = PS["DOM.XML3D.Indexed.Material"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Data_Semigroup = PS["Data.Semigroup"];
  ...
  var Wrap = (function () {
      function Wrap(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Wrap.create = function (value0) {
          return function (value1) {
              return new Wrap(value0, value1);
          };
      };
      return Wrap;
  })();
  var MinNearest = (function () {
      function MinNearest() {

      };
      MinNearest.value = new MinNearest();
      return MinNearest;
  })();
  var MinLinear = (function () {
      function MinLinear() {

      };
      MinLinear.value = new MinLinear();
      return MinLinear;
  })();
  var MinNearestMipmapNearest = (function () {
      function MinNearestMipmapNearest() {

      };
      MinNearestMipmapNearest.value = new MinNearestMipmapNearest();
      return MinNearestMipmapNearest;
  })();
  var MinNearestMipmapLinear = (function () {
      function MinNearestMipmapLinear() {

      };
      MinNearestMipmapLinear.value = new MinNearestMipmapLinear();
      return MinNearestMipmapLinear;
  })();
  var MinLinearMipmapNearest = (function () {
      function MinLinearMipmapNearest() {

      };
      MinLinearMipmapNearest.value = new MinLinearMipmapNearest();
      return MinLinearMipmapNearest;
  })();
  var MinLinearMipmapLinear = (function () {
      function MinLinearMipmapLinear() {

      };
      MinLinearMipmapLinear.value = new MinLinearMipmapLinear();
      return MinLinearMipmapLinear;
  })();
  var MagNearest = (function () {
      function MagNearest() {

      };
      MagNearest.value = new MagNearest();
      return MagNearest;
  })();
  var MagLinear = (function () {
      function MagLinear() {

      };
      MagLinear.value = new MagLinear();
      return MagLinear;
  })();
  var Filter = (function () {
  ...
  var renderWrapMode = function (v) {
      ...
      throw new Error("Failed pattern match at DOM.XML3D.Indexed.Texture line 10, column 18 - line 15, column 1: " + [ v.constructor.name ]);
  };
  var renderWrap = function (v) {
      return renderWrapMode(v.value0) + (" " + renderWrapMode(v.value1));
  };
  var renderMinFilter = function (v) {
      if (v instanceof MinNearest) {
          return "nearest";
      };
      if (v instanceof MinLinear) {
          return "linear";
      };
      if (v instanceof MinNearestMipmapNearest) {
          return "nearest-mipmap-nearest";
      };
      if (v instanceof MinNearestMipmapLinear) {
          return "nearest-mipmap-linear";
      };
      if (v instanceof MinLinearMipmapNearest) {
          return "linear-mipmap-nearest";
      };
      if (v instanceof MinLinearMipmapLinear) {
          return "linear-mipmap-linear";
      };
      throw new Error("Failed pattern match at DOM.XML3D.Indexed.Texture line 29, column 19 - line 37, column 1: " + [ v.constructor.name ]);
  };
  var renderMagFilter = function (v) {
      if (v instanceof MagNearest) {
          return "nearest";
      };
      if (v instanceof MagLinear) {
          return "linear";
      };
      throw new Error("Failed pattern match at DOM.XML3D.Indexed.Texture line 42, column 19 - line 46, column 1: " + [ v.constructor.name ]);
  };
  var renderFilter = function (v) {
      return renderMinFilter(v.value0) + (" " + renderMagFilter(v.value1));
  };
  exports["Filter"] = Filter;
  exports["MagNearest"] = MagNearest;
  exports["MagLinear"] = MagLinear;
  exports["MinNearest"] = MinNearest;
  exports["MinLinear"] = MinLinear;
  exports["MinNearestMipmapNearest"] = MinNearestMipmapNearest;
  exports["MinNearestMipmapLinear"] = MinNearestMipmapLinear;
  exports["MinLinearMipmapNearest"] = MinLinearMipmapNearest;
  exports["MinLinearMipmapLinear"] = MinLinearMipmapLinear;
  exports["Wrap"] = Wrap;
  exports["Repeat"] = Repeat;
  exports["Clamp"] = Clamp;
  exports["renderFilter"] = renderFilter;
  exports["renderMagFilter"] = renderMagFilter;
  exports["renderMinFilter"] = renderMinFilter;
  exports["renderWrap"] = renderWrap;
  exports["renderWrapMode"] = renderWrapMode;
})(PS["DOM.XML3D.Indexed.Texture"] = PS["DOM.XML3D.Indexed.Texture"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Data_Semigroup = PS["Data.Semigroup"];
  ...
  var renderVec3 = function (v) {
      return Data_Show.show(Data_Show.showNumber)(v.value0) + (" " + (Data_Show.show(Data_Show.showNumber)(v.value1) + (" " + (Data_Show.show(Data_Show.showNumber)(v.value2) + " "))));
  };
  exports["Vec3"] = Vec3;
  exports["renderVec3"] = renderVec3;
})(PS["DOM.XML3D.Indexed.Vec3"] = PS["DOM.XML3D.Indexed.Vec3"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  ...
  var Projective = (function () {
      ...
      Projective.value = new Projective();
      return Projective;
  })();
  var renderViewModel = function (v) {
      if (v instanceof Perspective) {
          return "urn:xml3d:view:perspective";
      };
      if (v instanceof Projective) {
          return "urn:xml3d:view:projective";
      };
      throw new Error("Failed pattern match at DOM.XML3D.Indexed.View line 8, column 19 - line 10, column 17: " + [ v.constructor.name ]);
  };
  exports["Perspective"] = Perspective;
  exports["Projective"] = Projective;
  exports["renderViewModel"] = renderViewModel;
})(PS["DOM.XML3D.Indexed.View"] = PS["DOM.XML3D.Indexed.View"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  var DOM_XML3D_Indexed = PS["DOM.XML3D.Indexed"];
  var DOM_XML3D_Indexed_IVec4 = PS["DOM.XML3D.Indexed.IVec4"];
  var DOM_XML3D_Indexed_Mat4 = PS["DOM.XML3D.Indexed.Mat4"];
  var DOM_XML3D_Indexed_Vec2 = PS["DOM.XML3D.Indexed.Vec2"];
  var DOM_XML3D_Indexed_Vec3 = PS["DOM.XML3D.Indexed.Vec3"];
  var Data_Function = PS["Data.Function"];
  var Data_Functor = PS["Data.Functor"];
  var Data_Show = PS["Data.Show"];
  var Halogen_HTML_Core = PS["Halogen.HTML.Core"];
  ...
  var Halogen_VDom_Types = PS["Halogen.VDom.Types"];
  var Prelude = PS["Prelude"];        
  var xml3d = Halogen_HTML_Elements.element("xml3d");
  var view = Halogen_HTML_Elements.element("view");
  var transform = Halogen_HTML_Elements.element("transform");
  var texture = Halogen_HTML_Elements.element("texture");
  var model = Halogen_HTML_Elements.element("model");
  var mesh = Halogen_HTML_Elements.element("mesh");
  var material = Halogen_HTML_Elements.element("material");
  var light = Halogen_HTML_Elements.element("light");
  var group = Halogen_HTML_Elements.element("group");
  var float3 = function (p) {
      return function (vs) {
          return Halogen_HTML_Elements.element("float3")(p)(Data_Functor.map(Data_Functor.functorArray)(function ($3) {
              return Halogen_HTML_Core.text(DOM_XML3D_Indexed_Vec3.renderVec3($3));
          })(vs));
      };
  };
  var $$float = function (p) {
      return function (vs) {
          return Halogen_HTML_Elements.element("float")(p)(Data_Functor.map(Data_Functor.functorArray)(function ($5) {
              return Halogen_HTML_Core.text(Data_Show.show(Data_Show.showNumber)($5));
          })(vs));
      };
  };
  var defs = Halogen_HTML_Elements.element("defs");          
  var assetdata = Halogen_HTML_Elements.element("assetdata");
  ...
  exports["view"] = view;
  exports["xml3d"] = xml3d;
})(PS["Halogen.XML3D.Elements"] = PS["Halogen.XML3D.Elements"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  var DOM_Event_Types = PS["DOM.Event.Types"];
  var DOM_XML3D_Event_Types = PS["DOM.XML3D.Event.Types"];
  var Data_Maybe = PS["Data.Maybe"];
  var Halogen_HTML_Events = PS["Halogen.HTML.Events"];
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];
  var Unsafe_Coerce = PS["Unsafe.Coerce"];        
  var frameDrawnHandler = Unsafe_Coerce.unsafeCoerce;
  var onFrameDrawn = function ($0) {
      return Halogen_HTML_Events.handler("framedrawn")(frameDrawnHandler($0));
  };
  exports["frameDrawnHandler"] = frameDrawnHandler;
  exports["onFrameDrawn"] = onFrameDrawn;
})(PS["Halogen.XML3D.Events"] = PS["Halogen.XML3D.Events"] || {});
(function(exports) {
    "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  var DOM_HTML_Indexed = PS["DOM.HTML.Indexed"];
  var DOM_XML3D_Indexed_AxisAngle = PS["DOM.XML3D.Indexed.AxisAngle"];
  var DOM_XML3D_Indexed_Light = PS["DOM.XML3D.Indexed.Light"];
  var DOM_XML3D_Indexed_Material = PS["DOM.XML3D.Indexed.Material"];
  var DOM_XML3D_Indexed_Mesh = PS["DOM.XML3D.Indexed.Mesh"];
  var DOM_XML3D_Indexed_Texture = PS["DOM.XML3D.Indexed.Texture"];
  var DOM_XML3D_Indexed_Vec3 = PS["DOM.XML3D.Indexed.Vec3"];
  var DOM_XML3D_Indexed_View = PS["DOM.XML3D.Indexed.View"];
  var Data_Show = PS["Data.Show"];
  var Halogen_HTML_Core = PS["Halogen.HTML.Core"];
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];        
  var wrap = function ($0) {
      return Halogen_HTML_Properties.attr("wrap")(DOM_XML3D_Indexed_Texture.renderWrap($0));
  };
  var viewModel = function ($2) {
      return Halogen_HTML_Properties.attr("model")(DOM_XML3D_Indexed_View.renderViewModel($2));
  };
  var translation = function ($3) {
      return Halogen_HTML_Properties.attr("translation")(DOM_XML3D_Indexed_Vec3.renderVec3($3));
  };
  var transform = Halogen_HTML_Properties.attr("transform");
  var src = Halogen_HTML_Properties.attr("src");
  var scale = function ($4) {
      return Halogen_HTML_Properties.attr("scale")(DOM_XML3D_Indexed_Vec3.renderVec3($4));
  };
  var rotation = function ($5) {
      return Halogen_HTML_Properties.attr("rotation")(DOM_XML3D_Indexed_AxisAngle.renderAxisAngle($5));
  };
  var name = Halogen_HTML_Properties.attr("name");
  var material = Halogen_HTML_Properties.attr("material");
  var matModel = function ($6) {
      return Halogen_HTML_Properties.attr("model")(DOM_XML3D_Indexed_Material.renderMatModel($6));
  };
  var lightModel = function ($7) {
      return Halogen_HTML_Properties.attr("model")(DOM_XML3D_Indexed_Light.renderLightModel($7));
  };
  var id = Halogen_HTML_Properties.prop(Halogen_HTML_Core.stringIsProp)("id");
  var filter = function ($9) {
      return Halogen_HTML_Properties.attr("filter")(DOM_XML3D_Indexed_Texture.renderFilter($9));
  };
  exports["filter"] = filter;
  exports["id"] = id;
  exports["lightModel"] = lightModel;
  exports["matModel"] = matModel;
  exports["material"] = material;
  exports["name"] = name;
  ...
  exports["wrap"] = wrap;
})(PS["Halogen.XML3D.Properties"] = PS["Halogen.XML3D.Properties"] || {});
(function(exports) {
    "use strict";
  var CSS = PS["CSS"];
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Halogen_XML3D_Elements = PS["Halogen.XML3D.Elements"];
  var Halogen_XML3D_Events = PS["Halogen.XML3D.Events"];
  var Halogen_XML3D_Properties = PS["Halogen.XML3D.Properties"];
  var $$Math = PS["Math"];
  var Prelude = PS["Prelude"];        
  var Move = (function () {
  ...
  var Touch = (function () {
      function Touch(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Touch.create = function (value0) {
          return function (value1) {
              return new Touch(value0, value1);
          };
      };
      return Touch;
  })();
  var Drawn = (function () {
      function Drawn(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Drawn.create = function (value0) {
          return function (value1) {
              return new Drawn(value0, value1);
          };
      };
      return Drawn;
  })();
  var example = (function () {
      var render = function (s) {
          var hp = function (m) {
              return [ Halogen_XML3D_Elements.group([ Halogen_XML3D_Properties.transform("#headingTransform") ])([ Halogen_XML3D_Elements.group([ Halogen_XML3D_Properties.transform("#pitchTransform") ])(m) ]) ];
          };
          var fy = Data_Int.toNumber(s.my);
          var g = fy / 512.0;
          var fx = Data_Int.toNumber(s.mx);
          var r = fx / 512.0;
          var b = r + g;
          var col = new DOM_XML3D_Indexed_Vec3.Vec3(r, g, b);
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("_xml3d_hideDiv"), Halogen_HTML_Events.onMouseMove(Halogen_HTML_Events.input(Move.create)), Halogen_HTML_Events.onTouchMove(Halogen_HTML_Events.input(Touch.create)) ])([ Halogen_XML3D_Elements.xml3d([ Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundColor(Color.rgba(0)(0)(255)(1.0)))(function () {
              return CSS_Geometry.width(CSS_Size.pct(100.0));
          })), Halogen_XML3D_Events.onFrameDrawn(Halogen_HTML_Events.input(Drawn.create)) ])([ Halogen_XML3D_Elements.defs([  ])([ Halogen_XML3D_Elements.material([ Halogen_XML3D_Properties.id("mouseMat"), Halogen_XML3D_Properties.matModel(DOM_XML3D_Indexed_Material.Phong.value) ])([ Halogen_XML3D_Elements.float3([ Halogen_XML3D_Properties.name("diffuseColor") ])([ new DOM_XML3D_Indexed_Vec3.Vec3(r, g, b) ]), Halogen_XML3D_Elements["float"]([ Halogen_XML3D_Properties.name("ambientIntensity") ])([ 0.5 ]) ]), Halogen_XML3D_Elements.material([ Halogen_XML3D_Properties.id("videoMat"), Halogen_XML3D_Properties.matModel(DOM_XML3D_Indexed_Material.Phong.value) ])([ Halogen_XML3D_Elements.float3([ Halogen_XML3D_Properties.name("diffuseColor") ])([ new DOM_XML3D_Indexed_Vec3.Vec3(1.0, 1.0, 1.0) ]), Halogen_XML3D_Elements.texture([ Halogen_XML3D_Properties.name("diffuseTexture"), Halogen_XML3D_Properties.filter(new DOM_XML3D_Indexed_Texture.Filter(DOM_XML3D_Indexed_Texture.MinLinear.value, DOM_XML3D_Indexed_Texture.MagLinear.value)), Halogen_XML3D_Properties.wrap(new DOM_XML3D_Indexed_Texture.Wrap(DOM_XML3D_Indexed_Texture.Clamp.value, DOM_XML3D_Indexed_Texture.Clamp.value)) ])([  ]) ]), Halogen_XML3D_Elements.transform([ Halogen_XML3D_Properties.id("cameraTransform"), Halogen_XML3D_Properties.translation(new DOM_XML3D_Indexed_Vec3.Vec3(0.0, 0.0, 250.0)) ])([  ]), Halogen_XML3D_Elements.transform([ Halogen_XML3D_Properties.id("objectTransform"), Halogen_XML3D_Properties.translation(new DOM_XML3D_Indexed_Vec3.Vec3(-50.0, -50.0, 0.0)) ])([  ]), Halogen_XML3D_Elements.transform([ Halogen_XML3D_Properties.id("engineerTransform"), Halogen_XML3D_Properties.translation(new DOM_XML3D_Indexed_Vec3.Vec3(50.0, -50.0, 0.0)) ])([  ]), Halogen_XML3D_Elements.transform([ Halogen_XML3D_Properties.id("planeTransform"), Halogen_XML3D_Properties.translation(new DOM_XML3D_Indexed_Vec3.Vec3(-50.0, 50.0, 0.0)), Halogen_XML3D_Properties.scale(new DOM_XML3D_Indexed_Vec3.Vec3(10.0, 10.0, 10.0)) ])([  ]), Halogen_XML3D_Elements.transform([ Halogen_XML3D_Properties.id("ciccioTransform"), Halogen_XML3D_Properties.translation(new DOM_XML3D_Indexed_Vec3.Vec3(50.0, 50.0, 0.0)), Halogen_XML3D_Properties.scale(new DOM_XML3D_Indexed_Vec3.Vec3(1.0, 1.0, 1.0)) ])([  ]), Halogen_XML3D_Elements.transform([ Halogen_XML3D_Properties.id("pitchTransform"), Halogen_XML3D_Properties.rotation(new DOM_XML3D_Indexed_AxisAngle.AxisAngle(1.0, 0.0, 0.0, fy / 50.0)) ])([  ]), Halogen_XML3D_Elements.transform([ Halogen_XML3D_Properties.id("headingTransform"), Halogen_XML3D_Properties.rotation(new DOM_XML3D_Indexed_AxisAngle.AxisAngle(0.0, 1.0, 0.0, fx / 50.0)) ])([  ]), Halogen_XML3D_Elements.light([ Halogen_XML3D_Properties.lightModel(DOM_XML3D_Indexed_Light.Directional.value) ])([ Halogen_XML3D_Elements.float3([ Halogen_XML3D_Properties.name("intensity") ])([ new DOM_XML3D_Indexed_Vec3.Vec3(1.0, 1.0, 1.0) ]) ]) ]), Halogen_XML3D_Elements.view([ Halogen_XML3D_Properties.transform("#cameraTransform"), Halogen_XML3D_Properties.viewModel(DOM_XML3D_Indexed_View.Perspective.value) ])([  ]), Halogen_XML3D_Elements.group([ Halogen_XML3D_Properties.material("#mouseMat"), Halogen_XML3D_Properties.transform("#objectTransform") ])(hp([ Halogen_XML3D_Elements.mesh([ Halogen_XML3D_Properties.src("http://xml3d.github.io/xml3d-examples/examples/" + "assets/res/teapot/teapot.json"), Halogen_XML3D_Properties.transform("#pitchTransform") ])([  ]) ])), Halogen_XML3D_Elements.group([ Halogen_XML3D_Properties.transform("#planeTransform") ])(hp([ Halogen_XML3D_Elements.mesh([ Halogen_XML3D_Properties.src("http://xml3d.github.io/xml3d-examples/examples/" + "externalXml/resource/plane.xml#mesh1"), Halogen_XML3D_Properties.material("http://xml3d.github.io/xml3d-examples/examples/" + "externalXml/resource/plane.xml#shader_matte") ])([  ]) ])), Halogen_XML3D_Elements.group([ Halogen_XML3D_Properties.transform("#ciccioTransform") ])(hp([ Halogen_XML3D_Elements.model([ Halogen_XML3D_Properties.src("http://rawgit.com/xml3d/xml3d-examples/master/resources/assets/" + "robots/ciccio.xml#asset") ])([ Halogen_XML3D_Elements.assetdata([ Halogen_XML3D_Properties.name("animation") ])([ Halogen_XML3D_Elements["float"]([ Halogen_XML3D_Properties.name("key") ])([ $$Math.remainder(s.t / 1000.0)(16.875) ]) ]) ]) ])), Halogen_XML3D_Elements.group([ Halogen_XML3D_Properties.transform("#engineerTransform") ])(hp([ Halogen_XML3D_Elements.model([ Halogen_XML3D_Properties.src("http://xml3d.github.io/xml3d-examples/examples/" + "assets/res/assets.xml#engineer") ])([  ]) ])) ]) ]);
      };
      var initialState = {
          mx: 0, 
          my: 0, 
      ...
      var $$eval = (function () {
          ...
          return function (v) {
              if (v instanceof Move) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(move(DOM_Event_MouseEvent.clientX(v.value0))(DOM_Event_MouseEvent.clientY(v.value0)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              if (v instanceof Touch) {
                  var v1 = DOM_Event_TouchEvent.item(0)(DOM_Event_TouchEvent.touches(v.value0));
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  };
                  if (v1 instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(move(DOM_Event_TouchEvent.clientX(v1.value0))(DOM_Event_TouchEvent.clientY(v1.value0)))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  };
                  throw new Error("Failed pattern match at Example line 160, column 7 - line 164, column 20: " + [ v1.constructor.name ]);
              };
              if (v instanceof Drawn) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $14.t = DOM_XML3D_Event_Types.timeStart(v.value0);
                      return $14;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              throw new Error("Failed pattern match at Example line 155, column 10 - line 167, column 16: " + [ v.constructor.name ]);
          };
      })();
...
(function(exports) {
  ...
  var buildVDom = function (spec) {
      var render = function (v) {
          ...
          throw new Error("Failed pattern match at Halogen.VDom.DOM line 59, column 12 - line 64, column 44: " + [ v.constructor.name ]);
      };
      return render;
  };
...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];        
  var head = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      initialState: Data_Function["const"](Data_Unit.unit), 
      render: Data_Function["const"](Halogen_HTML_Elements.script([ Halogen_HTML_Properties.src("http://www.xml3d.org/xml3d/script/xml3d.js") ])([  ])), 
      "eval": function ($0) {
          return Data_Void.absurd(Data_Newtype.unwrap(Data_Const.newtypeConst)($0));
      }, 
      receiver: Data_Function["const"](Data_Maybe.Nothing.value)
  });
  exports["head"] = head;
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitLoad)(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(Control_Bind.bindFlipped(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Halogen_VDom_Driver.runUI(Head.head)(Data_Unit.unit)))(Halogen_Aff_Util.selectElement("head")))(function () {
          return Control_Bind.bindFlipped(Control_Monad_Aff.bindAff)(Data_Foldable.traverse_(Control_Monad_Aff.applicativeAff)(Data_Foldable.foldableMaybe)(Halogen_VDom_Driver.runUI(Example.example)(Data_Unit.unit)))(Halogen_Aff_Util.selectElement("body"));
      });
  }));
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
